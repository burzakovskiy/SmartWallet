 ...
 */
public class NewOschadbankIntegration extends BasicNewBankIntegration {
    private final static String TAG = "NewOschadbankIntegration";
    private EditText mCardNumberEditText1;
    private EditText mCardNumberEditText4;
    private EditText mAccountNumber;

    public NewOschadbankIntegration() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_new_oschadbank_integration, container, false);
    }
    ...
    private boolean validateFields() {
        ...
        if (!mAccountNumber.getText().toString().isEmpty() && mAccountNumber.getText().toString().length() < 11) {
    ...
    private boolean isSMS() {
        ...
        OschadbankSMSParser parser = new OschadbankSMSParser(getContext(), 20);
        parser.setCardNumber(OschadbankSMSParser.convertCardNumber(mCardNumberEditText1.getText().toString(), mCardNumberEditText4.getText().toString()));
