 ...
 */
public class NewUkrsotsBankIntegration extends BasicNewBankIntegration {
    private final static String TAG = "UkrsotsBankIntegration";
    private EditText mCardNumberEditText1;
    private EditText mCardNumberEditText4;
    private EditText mAccountNumber;

    public NewUkrsotsBankIntegration() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_new_ukrsots_bank_integration, container, false);
    }
    ...
    private boolean isSMS() {
        ...
        UkrsotsbankSMSParser parser = new UkrsotsbankSMSParser(getContext(), 20);
        parser.setCardNumber(UkrsotsbankSMSParser.convertCardNumber(mCardNumberEditText1.getText().toString(), mCardNumberEditText4.getText().toString()));
