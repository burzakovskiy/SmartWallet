 ...
 */
public class NewRaiffeisenBankAvalIntegration extends BasicNewBankIntegration {
    private final static String TAG = "RaiffeisenIntegrationr";
    private EditText mCardNumberEditText3;
    private EditText mCardNumberEditText4;
    private EditText mAccountNumber;

    public NewRaiffeisenBankAvalIntegration() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_new_raiffeisen_bank_aval_integration, container, false);
    }

    @Override
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        super.onActivityCreated(savedInstanceState);
        mCardNumberEditText3 = (EditText) getActivity().findViewById(R.id.bank_integration_card_number_3);
    ...
    private void validateCard() {
        if (validateFields()) {
            ...
            if (isSMS() && mOnInitListener != null) {
                mCardNumberEditText3.setEnabled(false);
    ...
    private boolean validateFields() {
        if (mCardNumberEditText3.getText().toString().isEmpty()) {
            mCardNumberEditText3.requestFocus();
            Toast.makeText(getContext(), getString(R.string.set_value), Toast.LENGTH_LONG).show();
            return false;
        }
        if (mCardNumberEditText3.getText().toString().length() < 4) {
            mCardNumberEditText3.requestFocus();
        ...
        if (!mAccountNumber.getText().toString().isEmpty() && mAccountNumber.getText().toString().length() < 10) {
    ...
    private boolean isSMS() {
        RaiffeisenBankAvalSMSParser parser = new RaiffeisenBankAvalSMSParser(getContext(), 20);
        parser.setCardNumber(RaiffeisenBankAvalSMSParser.convertCardNumber(mCardNumberEditText3.getText().toString(), mCardNumberEditText4.getText().toString()));
    ...
    public String getCardNumber() {
        return mCardNumberEditText3.getText().toString() + mCardNumberEditText4.getText().toString();
    }
